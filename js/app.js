...
function checkCards() {
  ...
  if (openCards.length === 2) {
    ...
    if (
      openCards[0].getAttribute("data-pair") ==
      openCards[1].getAttribute("data-pair")
    ) {
      return "match";
    } else {
      return "noMatch";
